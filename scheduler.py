...
def get_scheduler(optimizer, lr_warm_epoch=20, lr_cos_epoch=0, lr_min=1e-12, lr_max=1e-4):
    """
    ...
    if lr_warm_epoch != 0 and lr_cos_epoch == 0:  #
        update_lr(optimizer, lr_low)  # 使用warmup需要吧lr初始化为最小lr
